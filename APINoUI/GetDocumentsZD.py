...
class EnovaApp:
    ...
    def send_request(self, param):
        ...
        service_url = "http://192.168.0.23:6001/api/ServiceImpApiANS/GetDokumentyHandloweZD"
    ...
    def format_data(self, data):
        table = []
        for item in data:
            table.append([item['ID'], item['Definicja'], item['Data'], item['Kontrahent'], item['NumerDokumentu']])
        return tabulate(table, headers=["ID", "Definicja", "Data", "Kontrahent", "NumerDokumentu"], tablefmt="grid")
