    ...
    def format_data(self, data):
        ...
        for index, item in enumerate(data):
            ...
            html += (
                ...
                f"<td class='{cls}'><div class='Buttons'><button class='AddContractorToHandel' value={item['ID']} title='Add Contractor to Document'><i class='icon ph-bold ph-plus'></i></button></div></td>"
                f"</tr>"
            )
        html += "</table>"
        return html