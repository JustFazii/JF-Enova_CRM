...
class APIGetGoodsDocHan:
    ...
    def format_data(self, data):
        html = "<table class='table-content'><thead><tr><th>ID<span class='icon-arrow'>&uparrow;</span></th><th class='active asc'>Code<span class='icon-arrow'>&uparrow;</span></th><th>Name<span class='icon-arrow'>&uparrow;</span></th><th>Price<span class='icon-arrow'>&uparrow;</span></th><th>Availability<span class='icon-arrow'>&uparrow;</span></th><th>Add</th></tr></thead>"
        for index, item in enumerate(data):
            ...
            html += (
                ...
                f"<td class='{cls}'><div class='Buttons'><button class='AddGoodsToHandel' value={item['ID']} title='Add Goods to Document'><i class='icon ph-bold ph-plus'></i></button></div></td>"
                f"</tr>"
            )
        html += "</table>"
        return html