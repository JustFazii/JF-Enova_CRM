...
class APIZDZKInvoice:
    ...
    def send_request(self, zk):
        print(zk)
        login_url = "http://192.168.0.23:6001/api/LoginApi"
        add_zk_url = f"http://192.168.0.23:6001/api/ServiceImpApiANS/GenerateInvoice?idDokumentuZO={zk['idDokumentuZO']}&typDokumentu=ZK"
