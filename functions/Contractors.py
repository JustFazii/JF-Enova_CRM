...
class EnovaApp:
    ...
    def send_request(self, param):
        ...
        try:
            ...
            html_table = self.generate_html_table(data)
            eel.update_output(html_table)
    ...
    def generate_html_table(self, data):
        html = "<table border='1'><tr><th>ID</th><th>Kod</th><th>Nazwa</th><th>Adres</th></tr>"
        for item in data:
